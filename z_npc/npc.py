...
from z_npc.chat import TextBubble
...
class NPC(Hitbox):
    def __init__(self, center, width, height, color, images, health=5):
        ...
        self.text.add_quests("Deliver 10 arrows:Plus 5 arrow multiplier", "1A10M5")
        self.text.add_quests("Break 5 barrels:Plus 10 range", "2B5R10")
        self.text.add_quests("Deliver 15 arrows:Plus 5 arrow multiplier", "1A15M5")
        self.text.add_quests("Break 10 barrels:Plus 20 range", "2B10R20")
        self.text.add_quests("Deliver 20 arrows:Plus 10 arrow multiplier", "1A20M10")
        self.text.add_quests("Break 20 barrels:Plus 25 range", "2B20R25")
        self.text.add_quests("Deliver 10 watermelons:Plus 10 arrow multiplier", "1W10M10")
        self.text.add_quests("Break 40 barrels:Plus 35 range", "2B40R35")
        self.text.add_quests("Deliver 20 watermelons:Plus 15 arrow multiplier", "1W20M15")
        self.text.add_quests("Break 50 barrels:Plus 30 range", "2B50R30")
        self.text.add_quests("Deliver 30 watermelons:Plus 15 arrow multiplier", "1W30M15")
